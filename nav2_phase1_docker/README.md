...
questions, read the **[Phase 1 architecture and interview guide](PHASE1_GUIDE.md)**.
...
- **Phase 1 — implemented here:** known-map navigation with AMCL.
- **[Phase 2 — implemented](../nav2_phase2_docker/README.md):** build the map
  online with SLAM Toolbox and navigate within observed space.
- **Phase 3 — proposed:** dynamic obstacles, replanning, recovery, Collision
  Monitor, and optional RGB-D PointCloud2 costmap input.
